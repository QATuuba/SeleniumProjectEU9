...
public class T4_findElements {
    ...
    public static void main(String[] args) {
        ...
        for (WebElement each : allLinks) {
            //System.out.println("Text of link: " + each);// =====> Text of link: [[ChromeDriver: chrome on WINDOWS (2c898097b94662febac4e22082727e45)] -> tag name: a]
                                                                //Text of link: [[ChromeDriver: chrome on WINDOWS (2c898097b94662febac4e22082727e45)] -> tag name: a]
